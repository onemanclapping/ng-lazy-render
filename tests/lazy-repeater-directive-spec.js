describe(`lazyRepeater directive`, () => {
    ...
    beforeEach(() => {
        ...
        inject([
            ...
            `$templateCache`,
            `$timeout`,
            (_$animate_, _$compile_, _$rootScope_, _$templateCache_, _$timeout_) => {
                $animate = _$animate_
                $compile = _$compile_
    ...
    it(`should increase the number of shown elements of a repeater as we see the last one`, () => {
